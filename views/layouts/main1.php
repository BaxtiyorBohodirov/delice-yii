...
<body class="d-flex flex-column h-100">
    ...
    <div class="header header-h">
                        ...
                        <div class="header-top-search">
                            <div class="search-modal" style="display: none">
                                <form method="post" action=<?=Url::to(["/site/search-result"])?> class="search-modal-form">
                                    <input type="text" class="search-modal-input" name="keyword" placeholder="поиск по сайту" value=<?=$keyword?:"";?> >
                                    <button type="submit" class="search-modal-icon">
        ...
        <div class="header-slider">
            <div class="slider" style="background: Url(<?php echo $model->link ?>) no-repeat">
                <div class="slider-info">
                    <h2 class="slider-title wow fadeInRight" data-wow-duration="2s"><?php echo $model->title_uz ?> </h2>
                    <div class="slider-devider"></div>
                    <p class="slider-text">
                        <?php echo $model->content_uz ?>
                    </p>1
            ...
            <div class="slider" style="background: url(<?php echo Carousel::getImageLink('header-back.png') ?>) no-repeat">
                <div class="slider-info">
                    <h2 class="slider-title wow bounceInRight" data-wow-duration="2s"><?php echo $model->title_uz ?></h2>
                    <div class="slider-devider wow swing"></div>

                    <p class="slider-text wow fadeInDown">
                        <?php echo $model->content_uz ?>
                    </p>
                    <div class="slider-button">
                        <button class="slider-button-first wow wobble">Подробнее</button>
                        <button class="slider-button-two wow rotateInDownRight">Заказать</button>
                    </div>
                </div>
            </div>
            <div class="slider" style="background: url(<?php echo Carousel::getImageLink('header-back.png') ?>) no-repeat">
