        ...
        <div class="nav-menu flex-row">
            ...
            <div class="nav-block">
                ...
                <div class="social">
                    ...
                    <!--                        <img src="app/images/cart.png" alt="">-->
                    <!--                    </a>-->
...
<div class="container">
    <div class="about-text">
        <div class="delice-text">
            <p class="section-first-text">Предприятие DELICE CHOCOLATE успешно занимается производством в Узбекистане
                шоколада более 10 лет на новом российском оборудовании, не имеющих аналогов во всей Средней Азии.
                Предприятие производит продукцию на импортном сырье, в частности, производства Казахстан, Турция,
                Франция, России и т.д.
            </p>
        </div>
        <div class="delice-text">
            <p class="section-first-text">Мощность нашего производства позволяет выпускать 250 тн. готовой продукции в
                месяц. На сегодняшний день налажен полноценный производственный процесс. Наша предприятие обеспечивает
                продукцией Республику Узбекистан и готовы экспортировать продукцию в страны ближнего зарубежья.
            </p>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="de-about-info">
            <div class="de-about-img">
                <img src="app/images/about-m.png" alt="">
            </div>
            <div class="de-about-info-item">
                <h4 class="de-about-info-title">Наша миссия</h4>
        ...
        <div class="container">
            <div class="main-slider-info">
                ...
                <div class="main-slider-info-text">
                    <p>Натуральность и соответствие всем международным стандартам, позволяет потреблять продукт всем
                        возрастным категориям. За всё время существования нашего предприятия количество покупателей
                        только
                        увеличивалось, были заключены долгосрочные договора на поставку нашей продукции. </p>
                </div>
                <h6 class="main-slider-title">ЕЛЕНА ПЕТРОВА</h6>
                <div class="main-slider-text">
                    <p>АО “Билайн лимитед”</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 order-xl-0 order-lg-0 order-md-1 order-sm-1 order-1">
                    <div class="footer-info wow fadeInLeft" data-wow-duration="2s">
                        <div class="footer-info-title1"><span>Адрес:</span>
                            <p>Узбекистан, г. Ташкент
                                Ул. Садыка Азимова, 68</p></div>
                        <p class="footer-info-title"><span>Телефон:</span> +998 90 123 45 76</p>
                    </div>
                </div>
