...
class ProductsSearch extends Products
{
    ...
    {
        return [
            [['id', 'price', 'catalog_id', 'status', 'order'], 'integer'],
            [['image', 'title_uz', 'title_en', 'title_ru', 'sub_content_uz', 'sub_content_ru', 'sub_content_en', 'content_uz', 'content_ru', 'content_en'], 'safe'],
        ];
    }
